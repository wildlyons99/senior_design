...
add_file -constraint {camera_output_impl_1_cpe.ldc}
...
add_file -verilog -vlog_std v2001 {Z:/senior_design/0v7670_Verilog/camera_output/source/impl_1/camera_configure.v}
...
add_file -verilog -vlog_std v2001 {Z:/senior_design/0v7670_Verilog/camera_output/source/impl_1/seven_seg.v}
#-- top module name
set_option -top_module top
set_option -include_path {Z:/senior_design/0v7670_Verilog/camera_output}
set_option -include_path {Z:/senior_design/0v7670_Verilog/camera_output/mypll}
...
project -log_file {camera_output_impl_1.srf}
project -run -clean
