...
// Netlist written on Mon Feb 17 15:26:31 2025
...
//
// Verilog Description of module multa
// module wrapper written out since it is a black-box. 
//

//

module multa (clk_i, clk_en_i, rst_i, data_a_i, data_b_i, result_o) /* synthesis cpe_box=1 */ ;
    input clk_i;
    input clk_en_i;
    input rst_i;
    input [7:0]data_a_i;
